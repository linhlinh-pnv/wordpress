	...
	*/
	function site_top_bar(){
		  ...
		  echo '<div id="top-bar-wrap"><div class="container"><div class="d-flex align-items-center">';
			...
			echo '<ul class="info d-flex"><li class="flex-fill"><i class=""></i>  Your Trusted 24 Hours Service Provider! </li></ul>';
	...
	function site_header_layout(){
		...
		<div id="nav-wrap">
		  <div class="container">
			...
			<?php echo wp_kses( $this->get_site_navbar_icon(), $this->alowed_tags() );?>
			</div>
		  </div>
		</div>
		<?php		
